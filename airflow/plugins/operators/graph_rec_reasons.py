...
class GetGraphRecReasonsOperator(BaseOperator):
    ...
    def __init__(self,
        ...
        super(GetGraphRecReasonsOperator, self).__init__(*args, **kwargs)
    ...
    def execute(self, context):
        ...
        recs = RecommendationHelper.get_top_n_recommedation_reasons(data_sec_deg, self.n_recs)
